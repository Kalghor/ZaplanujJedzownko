                    ...
                    <div class="mt-4 ml-4 mr-4">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7">
                                    <input class="w-100 p-1" value="${sessionScope.loggedIn.firstName}" name="name">
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2"><h4>Nazwisko</h4></th>
                                <td class="col-7">
                                    <input class="w-100 p-1" value="${sessionScope.loggedIn.lastName}" name="surname">
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2"><h4>Email</h4></th>
                                <td class="col-3">
                                    <input class="p-1 w-100" type="text" value="${sessionScope.loggedIn.email}" name="email">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    <input name="id" value="${sessionScope.loggedIn.id}" hidden>
                </form>
            </div>
        </div>
    </div>
