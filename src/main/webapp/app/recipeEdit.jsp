            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="mt-4 ml-4 mr-4">
                    ...
                    <form method="post" action="/app/recipe/edit">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7">
                                    ...
                                    <input name="id" hidden value="${recipe.id}">
                                </td>
                            </tr>

                            <tr class="d-flex">
                                <th scope="row" class="col-2">Opis przepisu</th>
                                <td class="col-7"><textarea name="description" class="w-100 p-1" rows="5">${recipe.description}</textarea>
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input class="p-1" name="preparationTime" type="number" value="${recipe.preparationTime}">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row d-flex">
                            <div class="col-5 p-4">
                                <textarea class="w-100 p-1" name="preparationText" rows="10">${recipe.preparationText}</textarea>
                            </div>
                            <div class="col-2"></div>
